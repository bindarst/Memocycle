...
- Cause de l'échec Google sur la version Play : le client OAuth Android existant est associé à la clé historique de l'APK direct, alors que Google Play signe les téléchargements avec sa propre clé. Empreinte SHA-1 Play à enregistrer avec le package `app.memocycle.mobile` : `05:16:EF:26:8E:8D:4A:00:BD:86:B9:4F:9B:50:08:36:D7:C3:D9:3C`.
