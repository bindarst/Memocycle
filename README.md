...
Les nouveaux livrables signés sont `artifacts/Memocycle-v1.0.9.apk` et
`artifacts/Memocycle-v1.0.9.aab` (version Android 1.0.9, code 10), également
...
le fichier AAB. La version 1.0.7 est publiée sur le canal de test interne Google Play ; la 1.0.9 est prête à être importée. Cette version corrige l'en-tête des matières et modules aux titres longs sur les écrans Android étroits. Le canal est
