    ...
    topics: [
      {
        ...
        answer: "Ton compte utilise une identité fournie par Google ou Apple. Tes matières, cours, fiches, dates, réponses et réglages sont nécessaires au planning d’étude. Les données d’étude sont enregistrées sur le téléphone puis synchronisées avec le service MémoCycle lorsque la connexion le permet. Le chrono en cours reste local.",
        destination: "account",
